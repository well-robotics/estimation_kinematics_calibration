...
namespace crocoddyl
{
    ...
    template <typename Scalar>
    class ActuationModelFloatingBaseEstimationTpl;

    template <typename Scalar>
    class ActuationModelFloatingBaseArrivalTpl;
    ...
    template <typename Scalar>
    class ActionModelArrivalFwdDynamicsTpl;
    template <typename Scalar>
    struct ActionDataArrivalFwdDynamicsTpl;

    template <typename Scalar>
    class ActionModelArrivalFwdDynamicsIDTpl;
    template <typename Scalar>
    struct ActionDataArrivalFwdDynamicsIDTpl;
    ...
    template <typename Scalar>
    class ResidualCircularObstacleTpl;
    template <typename Scalar>
    struct ResidualDataCircularObstacleTpl;
    ...
    typedef ActuationModelFloatingBaseEstimationTpl<double> ActuationModelFloatingBaseEstimation;
    typedef ActuationModelFloatingBaseArrivalTpl<double> ActuationModelFloatingBaseArrival;
    typedef ActuationModelFloatingBaseArrivalIDTpl<double> ActuationModelFloatingBaseArrivalID;
    ...
    typedef ActionModelArrivalFwdDynamicsTpl<double> ActionModelArrivalFwdDynamics;
    typedef ActionModelArrivalFwdDynamicsIDTpl<double> ActionModelArrivalFwdDynamicsID;
    typedef ActionDataArrivalFwdDynamicsTpl<double> ActionDataArrivalFwdDynamics;
    typedef ActionDataArrivalFwdDynamicsIDTpl<double> ActionDataArrivalFwdDynamicsID;
    ...
    typedef DifferentialActionModelContactFwdDynamicsAnitescuSystemidTpl<double>
        DifferentialActionModelContactFwdDynamicsAnitescuSystemid;
    typedef DifferentialActionDataContactFwdDynamicsAnitescuSystemidTpl<double>
        DifferentialActionDataContactFwdDynamicsAnitescuSystemid;
    ...
    typedef ResidualCircularObstacleTpl<double> ResidualCircularObstacle;
    typedef ResidualDataCircularObstacleTpl<double> ResidualDataCircularObstacle;
    ...
    typedef StateMultibodyParamsTpl<double> StateMultibodyParams;

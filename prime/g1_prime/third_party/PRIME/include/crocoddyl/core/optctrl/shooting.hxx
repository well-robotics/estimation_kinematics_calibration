...
namespace crocoddyl
{
                                          ...
                                          const std::vector<VectorXs> &us)
  {
    ...
    // csvutil::saveVectorListToCSV("data_hopper/xs_shooting.csv", xs);
    // csvutil::saveVectorListToCSV("data_hopper/us_shooting.csv", us);
...
#pragma omp simd reduction(+ : cost_)
                                           ...
                                           std::vector<VectorXs> &xs)
  {
    ...
    // Log the force and mode
    std::vector<std::string> files = {
        "data_go1_rl/f_log.csv",
        "data_go1_rl/mode_log.csv"};

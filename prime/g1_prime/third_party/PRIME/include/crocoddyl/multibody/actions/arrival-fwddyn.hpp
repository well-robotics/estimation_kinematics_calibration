...
#ifndef CROCODDYL_MULTIBODY_ACTIONS_ARRIVAL_FWDDYN_HPP_
#define CROCODDYL_MULTIBODY_ACTIONS_ARRIVAL_FWDDYN_HPP_
...
namespace crocoddyl
{
  ...
  public:
    ...
    typedef ActionDataArrivalFwdDynamicsTpl<Scalar> Data;
     ...
     */
    ActionModelArrivalFwdDynamicsTpl(
    ...
    ActionModelArrivalFwdDynamicsTpl(
        ...
        const bool enable_force = false);
    virtual ~ActionModelArrivalFwdDynamicsTpl();
  ...
  template <typename _Scalar>
  struct ActionDataArrivalFwdDynamicsTpl : public ActionDataAbstractTpl<_Scalar>
  {
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    typedef _Scalar Scalar;
    typedef MathBaseTpl<Scalar> MathBase;
    ...
    explicit ActionDataArrivalFwdDynamicsTpl(Model<Scalar> *const model)
        : Base(model),
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include <crocoddyl/multibody/actions/arrival-fwddyn.hxx>

#endif // CROCODDYL_MULTIBODY_ACTIONS_ARRIVAL_FWDDYN_HPP_

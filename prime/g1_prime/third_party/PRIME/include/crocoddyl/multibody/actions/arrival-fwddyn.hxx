...
namespace crocoddyl
{
  ...
  ActionModelArrivalFwdDynamicsTpl<Scalar>::ActionModelArrivalFwdDynamicsTpl(
  ...
  template <typename Scalar>
  void ActionModelArrivalFwdDynamicsTpl<Scalar>::calc(
  ...
  template <typename Scalar>
  void ActionModelArrivalFwdDynamicsTpl<Scalar>::calcDiff(
      const boost::shared_ptr<ActionDataAbstract> &data,
      const Eigen::Ref<const VectorXs> &x, const Eigen::Ref<const VectorXs> &u)
  {
    Data *d = static_cast<Data *>(data.get());
  ...
  ActionModelArrivalFwdDynamicsTpl<Scalar>::createData()
  {
    return boost::allocate_shared<Data>(Eigen::aligned_allocator<Data>(), this);
  }

  template <typename Scalar>
  bool ActionModelArrivalFwdDynamicsTpl<Scalar>::checkData(
      const boost::shared_ptr<ActionDataAbstract> &data)
  {
  ...
  template <typename Scalar>
  void ActionModelArrivalFwdDynamicsTpl<Scalar>::quasiStatic(
  ...
  template <typename Scalar>
  std::size_t ActionModelArrivalFwdDynamicsTpl<Scalar>::get_ng() const
  {
    if (constraints_ != nullptr)
    {
  ...
  template <typename Scalar>
  std::size_t ActionModelArrivalFwdDynamicsTpl<Scalar>::get_nh() const
  {
    if (constraints_ != nullptr)
    {
  ...
  template <typename Scalar>
  std::size_t ActionModelArrivalFwdDynamicsTpl<Scalar>::get_ng_T() const
  {
    if (constraints_ != nullptr)
    {
  ...
  template <typename Scalar>
  std::size_t ActionModelArrivalFwdDynamicsTpl<Scalar>::get_nh_T() const
  {
    if (constraints_ != nullptr)
    {
  ...
  ActionModelArrivalFwdDynamicsTpl<Scalar>::get_g_lb() const
  {
    if (constraints_ != nullptr)
    {
  ...
  template <typename Scalar>
  const typename MathBaseTpl<Scalar>::VectorXs &
  ActionModelArrivalFwdDynamicsTpl<Scalar>::get_g_ub() const
  {
    if (constraints_ != nullptr)
    {
  ...
  template <typename Scalar>
  void ActionModelArrivalFwdDynamicsTpl<Scalar>::print(std::ostream &os) const
  {
  ...
  ActionModelArrivalFwdDynamicsTpl<Scalar>::get_pinocchio() const
  {
    return pinocchio_;
  }
  ...
  ActionModelArrivalFwdDynamicsTpl<Scalar>::get_actuation() const
  {
    return actuation_;
  }
  ...
  ActionModelArrivalFwdDynamicsTpl<Scalar>::get_costs() const
  {
    return costs_;
  }
  ...
  ActionModelArrivalFwdDynamicsTpl<Scalar>::get_constraints() const
  {
    return constraints_;
  }

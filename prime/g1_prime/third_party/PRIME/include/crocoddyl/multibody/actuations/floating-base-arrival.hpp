...
#ifndef CROCODDYL_MULTIBODY_ACTUATIONS_FLOATING_BASE_ARRIVAL_HPP_
#define CROCODDYL_MULTIBODY_ACTUATIONS_FLOATING_BASE_ARRIVAL_HPP_
...
namespace crocoddyl
{
  ...
  public:
     ...
     */
    explicit ActuationModelFloatingBaseArrivalTpl(
        boost::shared_ptr<StateMultibody> state)
        : Base(state,
               state->get_nv() + state->get_nv()) {};
    virtual ~ActuationModelFloatingBaseArrivalTpl() {};
...
#endif // CROCODDYL_MULTIBODY_ACTUATIONS_FLOATING_BASE_ARRIVAL_HPP_

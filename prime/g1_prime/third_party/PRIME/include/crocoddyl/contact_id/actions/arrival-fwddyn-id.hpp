...
#ifndef CROCODDYL_CONTACT_ID_ACTIONS_ARRIVAL_FWDDYN_ID_HPP_
#define CROCODDYL_CONTACT_ID_ACTIONS_ARRIVAL_FWDDYN_ID_HPP_
...
namespace crocoddyl
{
  ...
  public:
    ...
    typedef ActionDataArrivalFwdDynamicsIDTpl<Scalar> Data;
     ...
     */
    ActionModelArrivalFwdDynamicsIDTpl(
    ...
    ActionModelArrivalFwdDynamicsIDTpl(
        ...
        const bool enable_force = false);
    virtual ~ActionModelArrivalFwdDynamicsIDTpl();
  ...
  template <typename _Scalar>
  struct ActionDataArrivalFwdDynamicsIDTpl : public ActionDataAbstractTpl<_Scalar>
  {
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    typedef _Scalar Scalar;
    typedef MathBaseTpl<Scalar> MathBase;
    ...
    explicit ActionDataArrivalFwdDynamicsIDTpl(Model<Scalar> *const model)
        : Base(model),
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include <crocoddyl/contact_id/actions/arrival-fwddyn-id.hxx>

#endif // CROCODDYL_CONTACT_ID_ACTIONS_ARRIVAL_FWDDYN_ID_HPP_
